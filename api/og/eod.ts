...
//
// Generates a 1600x900 PNG end-of-day wrap card. Same neobrutalist layout
// as /api/og/digest but with "End of Day" framing.
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // See api/og/digest.ts for explanation.
  const markup = html(`
    <div
    ...
    >
      ...
      <div style="display: flex; padding: 40px 0 0 112px;">
        <span
          ...
          >3 things that moved markets today</span
        >
      </div>
      ...
      >
        <span
          style="font-family: Inter; font-weight: 500; font-size: 26px; color: ${GREY_TEXT};"
          >End of day wrap. See you tomorrow.</span
        >
        <span
  ...
  try {
    ...
    console.error("[og/eod] Generation failed:", err);
